            ...
            <div className="layout-container flex h-full grow flex-col relative z-30">
                ...
                <header className="flex items-center justify-between whitespace-nowrap px-6 md:px-10 py-8 w-full">
                    ...
                    <div className="hidden md:flex gap-4">
                        ...
                        <button onClick={() => navigate('/recruiter/talent-hunt')} className="flex min-w-[120px] cursor-pointer items-center justify-center overflow-hidden rounded-full h-11 px-6 bg-white/5 border border-white/10 text-white text-sm font-bold hover:bg-white/10 transition-all backdrop-blur-md">
